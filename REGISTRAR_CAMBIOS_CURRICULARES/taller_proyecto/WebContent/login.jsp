...
<head>
  ...
  <title>USMP - Taller de Proyecto</title>
...
textarea.error:not(.basic) { border-color: #900 !important }
...
#signup_form .switch_signup_method .alt_signup_link:hover { color: #900 }
...
body>#login form .login_link:hover { color: #900 }
...
body>#login #chrome_web_store a:hover { border-bottom: 2px solid #900 }
...
body>#login #dont_have_an_account a:hover { border-bottom: 2px solid #900 }
</style>
...
<body>
  ...
  <div id="login">
  <form id="login_form"  style="background-color:white">
    ...
    <div class="field_container">
      ...
      <button id="sign_in_button">
        ...
        <div id="remember_me_container">
          ...
          <label class="login_link" for="user_remember_me" id="remember_me_label">Recuerdame</label>
        </div>
