...
/**
 * Servlet implementation class CursoVsCurso
 */
@WebServlet("/CursoVsCurso")
public class G4_CursoVsCurso extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public G4_CursoVsCurso() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {			
			...
			request.getRequestDispatcher("/SimulacionMatricula/matriz.jsp").forward(request, response);	
...
try {
			...
			CursoVsCursoDAO  cursoDAO = daoF.obtenerCursoDAO();
			List<CursoVsCursoBean> listadoCiclos = cursoDAO.listar();
