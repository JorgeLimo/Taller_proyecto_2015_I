...
//Vector<CuotasBean> vectorcuota = new Vector();
	...
	if(request.getAttribute("vector")!=null){
		...
		vectortipocurso = (Vector)request.getAttribute("vectortipocurso");
	...
	session.setAttribute("dato", idcurso);
%>
...
<!-- Empieza Formulario con metodo POST -->
	      ...
	      <form name="form2" method="POST" action="AgregarLogro?dato=agregar">
	      	<!--  <input type="hidden" name="txt_idcurso" id="txt_idcurso" value="<%=idcurso%>"> -->
	      	      	<input type="hidden" name="txt_idcurso" id="txt_idcurso" value="<%=vectorlogro.get(0).getIdcurso()%>">
		  ...
		  <tr bgcolor="<%=colorear%>">
	        ...
	        <td align="center">
            <input type="checkbox" name="cbk_sel" id="checkbox" value="<%=vectorlogro.get(i).getIdtipocurso()%>"/>
            <label for="checkbox"></label>
            </td>
            <td align="center"><%=vectorlogro.get(i).getLogro() %>
            </td>
            <td align="center"><%=vectorlogro.get(i).getNivel() %>
            </td>
		...
		<table width="60%" border="0" align="left" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		    ...
		    <input style="background-color: F2F2F2" type="submit" name="Agregar Logro" id="Agregar Logro" value="Agregar Descripcion de Logro" />
	      </tr>
		  </table>
		  <!-- Fin de la tabla 3 -->
