...
<%-- <%@ page import="beans.G1PlanEstudioBean" %> --%>
<%-- <% List<G1PlanEstudioBean> planes =(List<G1PlanEstudioBean>)request.getAttribute("planes"); %> --%>
<%-- <%int cont = 1; %> --%>
	<!-- BEGIN HEADER -->
	<header>
			...
			<div class="sidebar">
				...
				<div class="title">Menu</div>
					<ul class="nav-sidebar">
                        ...
                        <li>
                            <a href="<%=application.getContextPath() %>/CalificacionLogros/index.jsp">
...
<%-- 	<script src="<%=application.getContextPath() %>/assets/plugins/jquery-1.11.1.min.js" type="text/javascript"></script> --%>
	...
	<!-- maniac -->
<%-- 	<script src="<%=applicatcion.getContextPath() %>/assets/js/maniac.js" type="text/javascript"></script> --%>
